...
namespace Eternal_Coin
{
  public class Lists
  {
    ...
    public static void InitializeLists()
    {
      ...
      {
        GVar.InventorySlot.helmet,
        GVar.InventorySlot.chestplate,
        GVar.InventorySlot.leggings,
        GVar.InventorySlot.leftBoot,
        GVar.InventorySlot.rightBoot,
        GVar.InventorySlot.leftGauntlet,
        GVar.InventorySlot.rightGauntlet,
        GVar.InventorySlot.leftHandWeapon,
        GVar.InventorySlot.rightHandWeapon,
        GVar.InventorySlot.RingOne,
        GVar.InventorySlot.RingTwo,
        GVar.InventorySlot.RingThree,
        GVar.InventorySlot.RingFour,
        GVar.InventorySlot.RingFive,
        GVar.InventorySlot.RingSix,
        GVar.InventorySlot.RingSeven,
        GVar.InventorySlot.RingEight
      };
    }
